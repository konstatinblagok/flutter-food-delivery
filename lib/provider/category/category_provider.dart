...
class CategoryProvider extends PsProvider {
  ...
  Future<dynamic> loadAllCategoryList(
      CategoryParameterHolder categoryParameterHolder) async {
    isLoading = true;

    isConnectedToInternet = await Utils.checkInternetConnectivity();

    await _repo.getAllCategoryList(categoryListStream, isConnectedToInternet,
        categoryParameterHolder, PsStatus.PROGRESS_LOADING);
  }
