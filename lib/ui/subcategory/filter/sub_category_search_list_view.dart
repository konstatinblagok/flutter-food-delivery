...
import 'package:fluttermultistoreflutter/ui/subcategory/item/sub_category_search_list_item.dart';
    ...
    _scrollController.addListener(() {
      if (_scrollController.position.pixels ==
        ...
        _subCategoryProvider.nextSubCategoryList(
            widget.categoryId, _subCategoryProvider.psValueHolder.shopId);
      }
    });
      ...
      child: PsWidgetWithAppBar<SubCategoryProvider>(
          ...
          onProviderReady: (SubCategoryProvider provider) {
            provider.loadSubCategoryList(
                widget.categoryId, provider.psValueHolder.shopId);
